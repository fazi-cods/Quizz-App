...
function checkCorrect(event) {
    ...
    let options = document.querySelectorAll("#quizOption li");
    options.forEach(opt => opt.style.pointerEvents = "none");
}
function showResult() {
    document.getElementById("result").innerHTML = `🎉 Quiz Finished! Your final score is <b>${score} / ${quiz.length * 10}</b>`;
